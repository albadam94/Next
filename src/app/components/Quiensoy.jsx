...
const Quiensoy = () => {
  return (
   ...
   <h1 className="text-white text-5xl font-semibold font-inter leading-[56px] md:mx-12 lg:mx-20 xl:mx-80 ">
   ...
   <div className="text-white text-base font-normal font-['Inter'] leading-normal  xl:mx-80 mt-10 md:w-[612px] w-fit ">
     <p>
